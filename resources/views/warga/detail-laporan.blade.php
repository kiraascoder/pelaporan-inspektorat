    ...
    <div class="space-y-6">
        <div class="bg-white rounded-lg shadow p-6 border border-gray-200">
            <div class="mb-4 flex justify-between items-center">
                ...
                <a href="{{ route('warga.laporan') }}" class="text-sm text-green-600 hover:underline">
            ...
            <div class="mt-4 flex items-center justify-end space-x-3">                
                <form action="{{ route('warga.laporan.destroy', $laporan->laporan_id) }}" method="POST"
                    ...
                    @method('DELETE')
                    <button type="submit"
                        class="px-3 py-2 text-xs font-medium rounded bg-red-600 text-white hover:bg-red-700">
                        Hapus
                    </button>
                </form>
            </div>
